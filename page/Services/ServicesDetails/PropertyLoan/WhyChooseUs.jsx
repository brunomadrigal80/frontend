...
import { Handshake, BadgePercent, Zap, Scale, Compass } from "lucide-react";
...
const WhyChooseUs = () => {
  const points = [
    {
      ...
      desc: "Count absolutely on our reliable, transparent, and trustworthy services.",
      icon: <Handshake className="w-8 h-8" />,
    },
    {
      title: "Competitive Interest Rates",
      desc: "Guaranteed best deals to make property ownership profoundly affordable.",
      icon: <BadgePercent className="w-8 h-8" />,
    },
    {
      title: "Fast Processing",
      desc: "Experience rapid operations resulting in exceptionally quick approvals.",
      icon: <Zap className="w-8 h-8" />,
    },
    {
      title: "Transparent Charges",
      desc: "Absolutely no hidden fees. Complete clarity throughout the entire process.",
      icon: <Scale className="w-8 h-8" />,
    },
    {
      title: "Expert Guidance",
      desc: "Dedicated real estate financial consultation and end-to-end support.",
  ...
  return (
    <section className="py-24 bg-[#0A192F] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-orange-500/10 rounded-full blur-[80px] pointer-events-none -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-16 tracking-tight">
            Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-400">Choose Us</span>
          </h2>
        </motion.div>
