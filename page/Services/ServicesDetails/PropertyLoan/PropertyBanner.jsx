...
const PropertyBanner = () => {
  ...
  const trustStats = [
    "2000+ Properties Financed",
    "₹100Cr+ Loans Disbursed",
    "4.8★ Customer Rating",
    "Safe & Secure Process"
  ];
      ...
      <section className="relative w-full flex items-center justify-center flex-col bg-gradient-to-b from-orange-50/50 to-white px-4 py-16 md:py-24 overflow-hidden">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-orange-100 text-orange-700 px-4 py-1.5 text-xs md:text-sm rounded-full border border-orange-200 flex items-center gap-x-2 font-semibold shadow-sm"
          >
            <Home size={18} />
          ...
          >
            Get quick approvals, unbeatable interest rates, and flexible tenure options. 
            Finance the property of your dreams effortlessly.
          </motion.p>
