...
import { Home, ChartCandlestick, Network, Hammer, CircleDollarSign } from "lucide-react";
import { motion } from "framer-motion";

const UseCases = () => {
  const cases = [
    { title: "Buy a New Home", icon: <Home className="w-6 h-6" />, color: "from-orange-400 to-orange-600" },
    { title: "Invest in Property", icon: <ChartCandlestick className="w-6 h-6" />, color: "from-indigo-400 to-indigo-600" },
    { title: "Expand Real Estate Portfolio", icon: <Network className="w-6 h-6" />, color: "from-cyan-400 to-cyan-600" },
    { title: "Renovate Your House", icon: <Hammer className="w-6 h-6" />, color: "from-orange-400 to-orange-600" },
    { title: "Get Funds Against Property", icon: <CircleDollarSign className="w-6 h-6" />, color: "from-blue-400 to-blue-600" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-16 text-lg">
            From purchasing your very first personal home to strategically expanding a massive real estate portfolio, we back your goals.
          </p>
        </motion.div>
