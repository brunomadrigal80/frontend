      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-500 mb-10 leading-relaxed max-w-lg">
            Our flexible eligibility parameters make owning a property achievable for people across all backgrounds.
          </p>
        ...
        >
          ...
          <img
            ...
            alt="Property Loan Eligibility Criteria"
          ...
          >
            <img src="https://res.cloudinary.com/dcgxjwv68/image/upload/v1775496904/cfs_assets/property-loan.jpg" alt="Property Loan Approvals" className="w-full h-full object-cover" />
          </motion.div>
        </motion.div>
