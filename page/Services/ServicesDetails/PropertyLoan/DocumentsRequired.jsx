...
import { FileText, CreditCard, BriefcaseBusiness, FileSpreadsheet, MapPin, Building2 } from "lucide-react";
...
const DocumentsRequired = () => {
  const docs = [
    ...
    { title: "Property Documents", icon: <Building2 className="w-6 h-6" /> },
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mb-16 text-lg">
            Having the right paperwork ready is the fastest way to get your property financing approved.
          </p>
        </motion.div>
