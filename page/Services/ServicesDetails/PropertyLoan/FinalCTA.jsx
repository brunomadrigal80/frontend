      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight">
            Own your dream property <br className="hidden md:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-400">with ease</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
            Apply today and get your property loan comprehensively approved quickly with reliable expert support.
          </p>
