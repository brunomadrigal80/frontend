...
const BannerSectionWebsiteDevelopment = () => {
  // Animation Variants (thoda fast kiya hai snappy feel ke liye)
  ...
  return (
    // Height ko kam karne ke liye min-h-[50vh] aur padding (py-10) adjust ki hai
    <section className="relative w-full flex items-center justify-center flex-col bg-gradient-to-b from-orange-50/50 to-white px-4 py-10 md:py-12 overflow-hidden">
      {/* Smaller Background Decorative Blobs */}
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 flex flex-col items-center max-w-4xl mx-auto space-y-5" // Gap kam kiya (space-y-5)
      >
        {/* Compact Badge */}
        <motion.div
        ...
        >
          Build a Powerful Online Presence <br className="hidden md:block" />{" "}
          with Our{" "}
          <span
            style={{
        ...
        >
          A company’s website is more than just an online presence — it’s the
          cornerstone of your brand, credibility, and business growth.{" "}
          <span className="text-gray-900 font-bold">
            At Crossover Fintech Support Pvt Ltd.
          </span>{" "}
          we act as a Website Development Company that builds professional,
          responsive, secure, and user-focused websites that help you attract,
          engage, and convert visitors into customers.
        </motion.p>

        {/* Smaller Call to Action Buttons */}
        <motion.div
          variants={itemVariants}
...
export default BannerSectionWebsiteDevelopment;
