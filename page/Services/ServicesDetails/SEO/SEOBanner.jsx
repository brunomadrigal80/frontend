...
import { IoMdSearch } from "react-icons/io"; // Search icon for SEO
    ...
    <>
      <section className="relative w-full flex items-center justify-center flex-col bg-gradient-to-b from-orange-50/50 to-white px-4 py-10 md:py-12 overflow-hidden">
        ...
        >
          ...
          >
            Dominate Search Results with <br className="hidden md:block" />
            <span
              style={{
          ...
          >
            ...
            , we help you climb the search rankings and stay there. Our SEO
            strategies are designed to increase your organic visibility, drive
            high-quality traffic, and deliver measurable ROI.
          </motion.p>
