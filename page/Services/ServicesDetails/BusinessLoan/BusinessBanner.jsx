    ...
    <>
      <section className="relative w-full flex items-center justify-center flex-col bg-gradient-to-b from-blue-50/50 to-white px-4 py-16 md:py-24 overflow-hidden">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-center text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0A192F] leading-tight tracking-tight max-w-4xl"
          >
            Fuel Your Enterprise with
            <br className="hidden md:block" /> Unstoppable{" "}
          ...
          >
            Get rapid collateral-free funding up to ₹50 Lakhs with ultra-competitive interest rates. Take your business to the next level today.
          </motion.p>
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
              {trustStats.map((stat, idx) => (
                <div key={idx} className="flex items-center gap-2 text-[#0A192F] font-medium text-sm md:text-base bg-white/60 px-4 py-2 rounded-full border border-gray-100 shadow-sm backdrop-blur-sm">
