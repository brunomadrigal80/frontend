...
import { Zap, Handshake, Compass, Scale, ShieldCheck } from "lucide-react";
  ...
  const points = [
    {
      ...
      desc: "Guaranteed rapid verification and virtually instant loan protocol approval.",
      icon: <Zap className="w-8 h-8" />,
    },
    {
      title: "Trusted by Businesses",
      desc: "Backed by an impeccably proven track record of successful corporate funding.",
      icon: <Handshake className="w-8 h-8" />,
    },
    {
      title: "Expert Financial Guidance",
      desc: "Comprehensive end-to-end strategic advisory custom-tailored to your industry.",
      icon: <Compass className="w-8 h-8" />,
    },
    {
      title: "Transparent Charges",
      desc: "What you see is exactly what you pay. Absolutely no hidden fees ever.",
      icon: <Scale className="w-8 h-8" />,
    },
    {
      title: "Secure Process",
      desc: "100% fortified, exceptionally safe, and strictly confidential application flow.",
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-16 tracking-tight">
            Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-500">Choose Us</span>
          </h2>
        </motion.div>
