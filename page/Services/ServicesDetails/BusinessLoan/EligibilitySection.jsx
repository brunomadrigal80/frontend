    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#0A192F] leading-tight mb-8">
            Check Your <br />
            <span className="text-orange-600">Eligibility</span>
          </h2>
          <p className="text-lg text-gray-500 mb-10 leading-relaxed max-w-lg">
            Our flexible underwriting standards mean your business has a significantly higher chance of instant approval.
          </p>
          ...
          >
            {points.map((item, index) => (
              ...
              >
                <div className="flex-shrink-0 w-10 h-10 bg-orange-50 text-orange-600 rounded-full flex items-center justify-center group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300">
        ...
        >
          ...
          <img
            ...
            alt="Business Loan Eligibility Criteria"
          ...
          >
            <img src="https://res.cloudinary.com/dcgxjwv68/image/upload/v1775496507/cfs_assets/business-loan-2.jpg" alt="Business Approvals" className="w-full h-full object-cover" onError={(e) => e.target.src = '/eligibility.jpg'} />
          </motion.div>
        </motion.div>
