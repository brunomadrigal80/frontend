      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">
            Need <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">urgent funds?</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
            Apply for a personal loan today and get instant approval with zero hassle.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <Link href="/contact-us" className="w-full sm:w-auto bg-gradient-to-r from-orange-500 to-orange-600 text-white px-10 py-4 text-lg rounded-full font-bold shadow-[0_10px_30px_-10px_rgba(249,115,22,0.8)] hover:shadow-[0_15px_40px_-10px_rgba(249,115,22,1)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2">
              Apply Now
            </Link>
