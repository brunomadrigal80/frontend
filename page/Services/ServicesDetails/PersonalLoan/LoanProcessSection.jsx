...
import { PencilLine, FileUp, CheckCircle2, HandCoins } from 'lucide-react';

const LoanProcessSection = () => {
  const steps = [
    { 
      title: "Apply Online", 
      desc: "Fill a quick application form to get started.",
      icon: <PencilLine className="w-8 h-8" />
    },
    { 
      title: "Upload Documents", 
      desc: "Submit basic documents securely.",
      icon: <FileUp className="w-8 h-8" />
    },
    { 
      title: "Instant Approval", 
      desc: "Get fast verification and approval within hours.",
      icon: <CheckCircle2 className="w-8 h-8" />
    },
    { 
      title: "Get Funds", 
      desc: "Amount credited directly to your bank account.",
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#0A192F] to-[#0F2A44] text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold mb-16 tracking-tight">
          Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Loan Process</span>
        </h2>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              <div className="bg-[#112F4E]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-8 hover:bg-[#153B61] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_40px_-15px_rgba(249,115,22,0.3)] h-full flex flex-col items-center cursor-pointer">
                ...
                {/* Step Number Badge */}
                <div className="absolute -top-4 w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-[0_0_15px_rgba(249,115,22,0.5)] ring-4 ring-[#0F2A44]">
                  {index + 1}
                </div>
